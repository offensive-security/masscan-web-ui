    ...
    <div id="sample_1_wrapper" class="dataTables_wrapper form-inline" role="grid">
        <div class="row-fluid">
            <div class="span6">
                <div class="dataTables_length" id="sample_1_length">
                    <label>
                        <select class="input-small" aria-controls="sample_1" size="1" name="rec_per_page"
                                onchange="searchData('<?php echo $rpp_data; ?>' + this.value)">
                            <option
                                value="10"<?php if ($filter['rec_per_page'] == 10): echo ' selected="selected"'; endif; ?>>
                                10
                            </option>
                            <option
                                value="20"<?php if ($filter['rec_per_page'] == 20): echo ' selected="selected"'; endif; ?>>
                                20
                            </option>
                            <option
                                value="30"<?php if ($filter['rec_per_page'] == 30): echo ' selected="selected"'; endif; ?>>
                                30
                            </option>
                            <option
                                value="50"<?php if ($filter['rec_per_page'] == 50): echo ' selected="selected"'; endif; ?>>
                                50
                            </option>
                            <option
                                value="100"<?php if ($filter['rec_per_page'] == 100): echo ' selected="selected"'; endif; ?>>
                                100
                            </option>
                        </select>
                        records per page
            ...
            <div class="span6">
                <div id="sample_1_filter" class="dataTables_filter">
                    <label>Search: <input class="input-small" aria-controls="sample_1" type="text"
                                          onkeyup="searchDataText('<?php echo $data_search; ?>'+this.value);"
                                          value="<?php echo htmlentities($filter['text']); ?>"></label>
                </div>
            </div>
        ...
        <table class="table table-striped table-bordered table-hover" id="sample_1">
            ...
            foreach ($results['data'] as $k => $r):
                ?>
                <tr class="odd gradeX">
                    <td class="ip"><a href="javascript:void(0);"
                                      onclick="return showIpHistory('<?php echo $r['ipaddress'] ?>', 'ip-<?php echo $k; ?>', '<?php echo $r['host_id']; ?>')"><?php echo $r['ipaddress']; ?></a>
                    </td>
                    <td class="banner">
        ...
        <div class="row-fluid">
            <div class="span6">
                <div id="sample_1_info" class="dataTables_info">Showing <?php echo $results['pagination']['from']; ?>
                    to <?php echo $results['pagination']['to']; ?> of <?php echo $results['pagination']['records']; ?>
                    entries
                </div>
            </div>
            <div class="span6">
                            ...
                            <?php if ((($results['pagination']['page'] - 3) < $i) && (($results['pagination']['page'] + 3) > $i)): ?>
                                <li class="<?php if ($results['pagination']['page'] == $i): echo "active"; endif; ?>">
                                    <a href="javascript:void(0);"
                                       onclick="searchData('<?php echo $pager_data . $i; ?>');"><?php echo (int)$i; ?></a>
                                </li>
                            <?php endif; ?>
                        <?php endfor; ?>
